...
Module.register('MMM-voice', {
    ...
    start() {
        ...
        this.mode = this.translate('VOICE_COMMANDS');
	...
	if (notification === 'ONE' ||
			...
			notification === 'NINE' ||
			notification === 'TEN') {
		this.sendNotification('LOAD_LOCATION', notification);
	} else if (notification === 'NEXT') {
		this.sendNotification('NEXT_LOCATIONS', 'next');
